...
- Added dependency-free regression checks for the inline application runtime and generators.
- Added Q-code and 10-code references, field-study prompts, voice input with fallback grading, shareable challenge links, embeddable mode, and Catppuccin/Nord themes.
